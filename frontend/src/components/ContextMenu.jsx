  ...
  const items = [
    ...
    },
    {
      ...
      actions: [
        ...
        ...(message.folder !== 'Snoozed' && !gtdSidebarEntry && !sidebarRow ? [{
        ...
        ...(categorizationActive && !gtdSidebarEntry && !sidebarRow ? [{
        ...
        ...(spamFolderPaths.size > 0 && !inSpamFolder && !gtdSidebarEntry && !sidebarRow ? [{
        ...
        ...(inSpamFolder && !gtdSidebarEntry && !sidebarRow ? [{
