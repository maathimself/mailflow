...
export default function MessagePane() {
  ...
  const prepared = useMemo(() => {
    ...
    return prepareEmailHtml(
      body.html,
      `${message?.id ?? 'preview'}-${appearance.renderMode}-${appearance.rootKey}`,
      { recovery: appearance.recovery },
    );
  }, [appearance.recovery, appearance.renderMode, appearance.rootKey, body?.html, message?.id]);
  ...
  useEffect(() => {
    ...
    const onLoaded = async () => {
      ...
      attachEmailBodyLinkHandler(doc);
  ...
  }, [appearance.recovery, appearance.rootKey, body?.html, iframeSourceToken, processEmailDraft, selectedMessageId]);
