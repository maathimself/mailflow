...
const PATHS = {
  ...
  twitter:   '<path d="M18.3 1.5h3.7l-8 9.2 9.4 12.8h-7.3l-5.2-6.9-6 6.9H1.1l8.6-9.8L1.1 1.5h7.5l4.7 6.3 5-6.3z"/>',
  ...
  domain:    '<circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 014 10 15.3 15.3 0 01-4 10 15.3 15.3 0 01-4-10 15.3 15.3 0 014-10z"/>',
};

export function getSocialIconSvgString(name, size = 16) {
  const paths = PATHS[name] || PATHS.domain;
...
export function SocialIcon({ name, size = 16, style }) {
  const paths = PATHS[name] || PATHS.domain;
