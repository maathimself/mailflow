...
describe('0041_search_fts.sql', () => {
  const sql = read('0041_search_fts.sql');
...
describe('0043_search_fts_index.sql', () => {
  const sql = read('0043_search_fts_index.sql');
...
describe('0045_embed_pending_index.sql', () => {
  const sql = read('0045_embed_pending_index.sql');
